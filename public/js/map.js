              ...
              '<div class="card-content" style="padding:12px">'+
                '<div class="media">'+
                  '<div class="media-left">'+
                    '<figure class="image is-32x32" style="height:47px;">'+
                      '<img src="./images/samplePic2.jpg" alt="Image" style="height: 42px; max-width: 38px;">'+
                    '</figure>'+
                  '</div>'+
                  '<div class="media-content">'+
                    '<p class="title is-5" style="font-size:18px; margin-bottom: 20px; line-height: 1.4; color: #363636">Matthew Alviz</p>'+
                    '<p class="subtitle is-6" style="margin-top: -20px; font-size: 14px; line-height: 1.4; color: #4a4a4a;">25 Successful Transaction</p>'+
                  '</div>'+
                '</div>'+
                '<div class="content" style="margin-top:18px; color: #4a4a4a; ">'+
                  ...
                  '<br><br>'+
                  '<small style="font-size: 11px;">11:09 PM - 1 Jan 2016</small>'+
                '</div>'+
              '</div>'+
            '</div>'+
          '</div>'+
